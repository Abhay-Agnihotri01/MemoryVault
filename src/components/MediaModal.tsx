  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/95 backdrop-blur-xl md:p-6">
      <div className="w-full h-full md:max-w-[95vw] md:h-[90vh] md:bg-slate-900 md:rounded-3xl md:border md:border-white/10 md:shadow-2xl md:overflow-hidden flex flex-col md:flex-row relative">
        ...
        <div className="md:hidden absolute top-0 left-0 right-0 pt-16 pb-4 px-4 flex justify-between items-start z-40 bg-gradient-to-b from-black/80 to-transparent pointer-events-none">
        ...
        >
          ...
          <div className="p-6 flex-grow overflow-y-auto mt-20 md:mt-0">
            <div className="mb-8 flex justify-between items-center md:block">
              ...
              {/* Mobile Close Panel Button inside panel */}
              <button 
